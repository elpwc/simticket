	...
	if (!isInitialLoading && works.length === 0) {
		return (
			<div className="works-empty">
				<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="text-gray-300 mb-3" viewBox="0 0 16 16" aria-hidden>
					<path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5z" />
				</svg>
				<p className="font-medium text-gray-700">{t('worksPage.empty.title')}</p>
				<p className="text-sm text-gray-500 mt-1 max-w-xs text-center">{t('worksPage.empty.description')}</p>
