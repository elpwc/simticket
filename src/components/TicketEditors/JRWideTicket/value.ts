...
export const JRPresetStations = [
	{
		...
		station1AreaChar: '山',
		station1en: 'TOKYO YAMANOTE LINE',
		station2: '北海道/医療大学',
		station2Type: JRStationNameType.LeftLargeAndRightSmall,
		station2AreaChar: '',
		station2en: 'HOKKAIDO-IRYODAIGAKU',
	...
	},
	{
		...
		station1Type: JRStationNameType.Normal,
		station1AreaChar: '豊',
		station1en: 'TOYOHARA CITY ZONE',
		station2: '樺太/工科大学前',
		station2Type: JRStationNameType.LeftUpAndDownRightLarge,
		station2AreaChar: '',
		station2en: 'KARAFUTO-KOKADAIGAKU-MAE',
		railways: ['新幹線', '樺太東'],
	},
	{
		station1: '札幌市内',
		station1Type: JRStationNameType.Normal,
		station1AreaChar: '札',
		station1en: 'SAPPORO CITY ZONE',
		station2: '豊原市内',
		station2Type: JRStationNameType.Normal,
		station2AreaChar: '豊',
		station2en: 'TOYOHARA CITY ZONE',
		railways: ['新幹線'],
	},
	{
		station1: '根室',
	...
	},
	{
		...
		station2AreaChar: '',
		station2en: 'MOTOBU-CHURAUMI-AQUARIUM',
		railways: ['沖縄', '名護'],
	},
	{
		station1: '（信）/横　川',
	...
	},
	{
		...
		station1Type: JRStationNameType.Normal,
		station1AreaChar: '那',
		station1en: 'NAHA CITY ZONE',
		station2: '国際/台　北',
		station2Type: JRStationNameType.LeftSmallAndRightLarge,
		station2AreaChar: '',
		station2en: '(INT.) TAIPEI',
	...
	},
	{
		...
		station1Type: JRStationNameType.Normal,
		station1AreaChar: '仙',
		station1en: 'SENDAI CITY ZONE',
		station2: 'ＢＲＴ/奇跡の一本松',
		station2Type: JRStationNameType.UpAlignLeftAndDownAlignCenter,
		station2AreaChar: '',
		station2en: 'KISEKI-NO-IPPON-MATSU(MIRACLE PINE)',
		railways: ['仙石', '石巻', 'BRT線'],
	},
	{
		station1: 'ＪＲ難波/(市内)',
		station1Type: JRStationNameType.LeftLargeAndRightSmall,
		station1AreaChar: '',
		station1en: 'JR NAMBA(CITY ZONE)',
		station2: 'りんくうタウン',
		station2Type: JRStationNameType.Small,
		station2AreaChar: '',
		station2en: 'RINKU-TOWN',
