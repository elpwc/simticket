...
const JRPresetStationNames = [
	...
	{ type: JRStationNameType.UpAndDownAlignLeft, company: 'E', name: '奥津軽/いまべつ', areaChar: '' },
	...
	{ type: JRStationNameType.UpAndDownAlignLeft, company: 'E', name: 'BRT/奇跡の一本松', areaChar: '' },
	...
	{ type: JRStationNameType.LeftSmallAndRightLarge, company: 'E', name: 'BRT/祝原', areaChar: '' },
